              ...
              <div className="space-y-8">
                ...
                <div>
                  <label className="block font-medium text-gray-900 mb-3">
                    Le propriétaire a-t-il déjà une annonce active sur Airbnb ? *
                  </label>
                  <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={() => handleInputChange('section_airbnb.annonce_active', true)}
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={() => handleInputChange('section_airbnb.annonce_active', false)}
                        className="w-4 h-4 text-[#dbae61] focus:ring-[#dbae61] cursor-pointer"
                      />
                      <span>Non</span>
                    </label>
                ...
                <div>
                  <label className="block font-medium text-gray-900 mb-2">URL de l'annonce Airbnb</label>
                  <input
                    type="url"
                    placeholder="https://www.airbnb.fr/rooms/11263237"
                    value={formData.url_annonce || ''}
                    onChange={(e) => handleInputChange('section_airbnb.url_annonce', e.target.value)}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          onChange={() => handleInputChange('section_airbnb.identifiants_obtenus', true)}
                          className="w-4 h-4 text-[#dbae61] focus:ring-[#dbae61] cursor-pointer"
                        />
                        <span>Oui</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          onChange={() => handleInputChange('section_airbnb.identifiants_obtenus', false)}
                          className="w-4 h-4 text-[#dbae61] focus:ring-[#dbae61] cursor-pointer"
                        />
                        <span>Non</span>
                      </label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange('section_airbnb.email_compte', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#dbae61] focus:border-transparent transition-all"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange('section_airbnb.mot_passe', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#dbae61] focus:border-transparent transition-all"
                        />
                      </div>
                    </div>
                  ...
                  {formData.identifiants_obtenus === false && (
                    <div>
                      <label className="block font-medium text-gray-900 mb-2">
                        Code Airbnb - Veuillez expliquer pourquoi vous n'avez pas obtenu les identifiants *
                      </label>
                      <textarea
                        placeholder="Expliquez les raisons..."
                        value={formData.explication_refus || ''}
                        onChange={(e) => handleInputChange('section_airbnb.explication_refus', e.target.value)}
                        rows={4}
