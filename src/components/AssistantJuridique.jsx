...
export default function AssistantJuridique() {
  ...
  const welcome = "Salut ! Je suis votre Assistant Juridique IA 🏡."
  ...
  const sendMessage = async (e) => {
    ...
    try {
      let requestBody = {
        chatInput: userInput,
        sessionId: `session_${Date.now()}_juridique`
      }
    ...
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-6 max-w-5xl mx-auto w-full">
          ...
          <h1 className="text-3xl font-bold text-[#dbae61] mb-1">Assistant Juridique IA</h1>
