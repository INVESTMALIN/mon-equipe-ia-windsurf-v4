...
export default function AssistantNegociateur() {
  ...
  useEffect(() => {
    ...
    let id = localStorage.getItem('conversation_id_negociateur')
    if (!id) {
      id = uuidv4()
      localStorage.setItem('conversation_id_negociateur', id)
    }
    ...
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-6 max-w-5xl mx-auto w-full">
          ...
          <h1 className="text-3xl font-bold text-[#dbae61] mb-1">Assistant Négociateur IA</h1>
